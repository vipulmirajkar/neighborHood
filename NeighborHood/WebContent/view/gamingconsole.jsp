...
<title>NeighborHood - Gaming Consoles</title>
<style type="text/css">
...
<body>
	...
	<hr />
	<div class="container">
		<h4 align="center">Gaming Consoles</h4>
		<hr />
	</div>
	<div class="container">
		<div class="main-iso">
			<%
				...
				try {
					...
					String query = "SELECT * FROM products AS r WHERE r.category = 9 AND r.p_id NOT IN(SELECT m.p_id FROM orders AS b JOIN orders_map AS m ON b.o_id = m.o_id WHERE b.start_date <='"
