...
<title>Enter OTP - NeighborHood</title>
<meta charset="utf-8">
<meta name="viewport"
	...
	<div class="container" style="padding-top: 150px;">
		<div class="jumbotron col-md-12">
			<div class="container bg-info" style="color: white;">
				<h2>Hello, Please Enter Your OTP.</h2>
			</div>
			<div class="container">
				<h4>You Will Receive Password In Your Mail Box.</h4>
			</div>
			<br />
			<div class="container col-md-3 col-md-push-1" align="left">
				<form action="<%=request.getContextPath()%>/forgotOtp"
					method="post">
