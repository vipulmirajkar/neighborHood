...
<title>NeighborHood - Appliances</title>
<style type="text/css">
		...
		<div class="main-iso">
			<%
				...
				try {
					...
					String query = "SELECT * FROM products AS r WHERE r.category = 7 AND r.p_id NOT IN(SELECT m.p_id FROM orders AS b JOIN orders_map AS m ON b.o_id = m.o_id WHERE b.start_date <='"
							+ sqlDate + "' AND b.end_date >='" + sqlDate + "')";
					//String query = "select * from products where category = 7";
					...
					ResultSet result = statement.executeQuery(query);
						while (result.next()) {
							...
							int productRate = Integer.parseInt(result
									.getString("rate"));
