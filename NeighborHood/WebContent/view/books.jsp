...
<title>NeighborHood - Books</title>
<style type="text/css">
...
<body>
	<!-- If no session, send user back to login page -->
	<%
		...
		<div class="main-iso">
			<%
				...
				try {
					...
					String query = "SELECT * FROM products AS r WHERE r.category = 1 AND r.p_id NOT IN(SELECT m.p_id FROM orders AS b JOIN orders_map AS m ON b.o_id = m.o_id WHERE b.start_date <='"
